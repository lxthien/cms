      ...
      <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet">
          ...
          <tr>
              ...
              <td>
								<div align="center">
									<?php
                    echo create_link_table('up_icon',$base_url.'admin/newscatalogues/up_position/'.$row->id,'up');
              ...
              <td>
                <div align="center">
                  <?php
                    echo create_link_table('edit_icon',$base_url.'admin/newscatalogues/edit/'.$row->id,'edit');
					...
					<?php foreach ($row->child->order_by('position','asc')->get() as $row_sub): $i++; ?>
      	  <tr>
              <td class="a-center"><div align="center"><?php echo $i;?></div></td>
