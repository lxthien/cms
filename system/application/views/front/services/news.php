        ...
        <div class="wrapper" style="margin-bottom:10px">
            ...
            <div class="wrapper content" style="margin-bottom:10px">
                <div class="box_inside" id="box_news">
                    ...
                    <div class="web-item">
                        <div class="div-img">
                            <a title="<?php echo $row->title_vietnamese; ?>" href="<?php echo $base_url.'dich-vu/'.$row->title_none.'.html'; ?>">
                                <img src="<?=image($row->dir.$row->image,'news_list');?>" alt="<?php echo $row->title_vietnamese; ?>">
                            </a>
                        </div>
                        <div class="div-desc">
                            <h4><a href="<?php echo $base_url.'dich-vu/'.$row->title_none.'.html'; ?>"><?php echo $row->title_vietnamese; ?></a></h4>
